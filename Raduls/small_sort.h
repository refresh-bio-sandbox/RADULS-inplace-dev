		...
		struct HybridSmallSortImpl
		{
			...
			void operator()(RECORD_T* data, uint32_t size)
			{
				if (size == 2)
					...
					custom_quick_sort<RECORD_T, SmallSorter_ro_ins, 24>(data, data + size, smallSorter_ro_ins);
			}
		};
		...
		struct HybridSmallSortImpl<Record<4, 1>>
		{
			...
			void operator()(RECORD_T* data, uint32_t size)
			{
				if (size == 2)
					...
					custom_quick_sort<RECORD_T, SamllSorter_ro, 24>(data, data + size, small_sorter_ro);
			}
		};
		...
		struct HybridSmallSortImpl<Record<3, 2>>
		{
			...
			void operator()(RECORD_T* data, uint32_t size)
			{
				if (size == 2)
					...
					custom_quick_sort<RECORD_T, SamllSorter_ro_ins_sort, 24>(data, data + size, small_sorter_ro_ins);
			}
		};
		...
		struct HybridSmallSortImpl<Record<2, 1>>
		{
			...
			void operator()(RECORD_T* data, uint32_t size)
			{
				if (size == 2)
					...
					custom_quick_sort<RECORD_T, SmallSorter_sn1, 24>(data, data + size, small_sorter_sn1);
			}
		};
		...
		struct HybridSmallSortImpl<Record<1,1>>
		{
			...
			void operator()(RECORD_T* data, uint32_t size)
			{
				if (size == 2)
					...
					custom_quick_sort<RECORD_T, SmallSorter, 56>(data, data + size, small_sorter);
			}
		};
